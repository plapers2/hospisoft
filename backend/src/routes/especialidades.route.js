...
router.get(
  "/especialidades/listarporid/:id",
  especialiadadesCtr.getEspecialidadesById,
);
...
router.put(
  "/especialidades/desactivar/:id",
  especialiadadesCtr.inactiveEspecialidad,
);
router.put(
  "/especialidades/activar/:id",
  especialiadadesCtr.activeEspecialidad,
);
